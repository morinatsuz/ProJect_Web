                        ...
                        <c:if test="${adminCheck == 'admin'}">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="CheckServlet"></a>
                                    <a class="dropdown-item" href="ManageEvent.jsp">จัดการกิจกรรม</a>
                            ...
                            <div class="input-group">
                                ...
                                <button type="submit" name="search" value="searched" class="btn btn-white btn-raised btn-fab btn-fab-mini btn-round">
                                    <i class="material-icons">trending_flat</i>
                                            ...
                                            <form action="CheckSerlvet" method="POST">
                        <button type="submit" name="view" value="manage">สร้างกิจกรรม</button>
                    </form>
